...
const I = (a) => new URL(String(a), location.href).href.replace(new RegExp(`^${location.origin}`), "");
class M {
  /**
...
let y;
const D = () => (y || (y = new M(), y.addFetchListener(), y.addCacheListener()), y);
function N(a, e, t) {
  let s;
  if (typeof a == "string") {
...
}, b = (a) => [f.prefix, a, f.suffix].filter((e) => e && e.length > 0).join("-"), W = (a) => {
